...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-pink-100 bg-white/80 py-10">
      <div
        id="footer-contact"
        className="flex w-full flex-col gap-8 px-4 text-center scroll-mt-24 sm:px-6 lg:px-10"
      >
        ...
        <div className="space-y-2 text-sm text-slate-600">
          <p>For inquiries and collaborations, send your message to:</p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-sm font-semibold text-slate-500">
          <a href="/#highlights" className="hover:text-rose-500">
            Highlights
          </a>
          <a href="/#gallery" className="hover:text-rose-500">
            Gallery
          </a>
          <a href="/#events" className="hover:text-rose-500">
            Events
          </a>
          <a href="/#footer-contact" className="hover:text-rose-500">
            Contact
          </a>
        </div>
