...
const AuditLogsTable = ({ items, loading }) => (
  <div className="mt-5 overflow-x-auto rounded-2xl border border-slate-200">
    <div className="min-w-[760px]">
      <div className="grid grid-cols-[1.2fr_0.9fr_1fr_1fr] gap-3 bg-slate-50 px-4 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">
        <span>Action</span>
        <span>Actor</span>
        <span>Entity</span>
        <span>Timestamp</span>
      ...
      {!loading &&
        items.map((item) => (
          <div
            ...
            className="grid grid-cols-[1.2fr_0.9fr_1fr_1fr] gap-3 border-t border-slate-200 px-4 py-3 text-sm text-slate-700"
          >
            <div>
